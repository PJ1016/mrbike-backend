...
const locationFeaturedCategories = require("./locationFeaturedCategoryRoutes")
const finance = require("./financeRoutes")
const preferences = require("./preferences/index")
const appContent = require("./app/index")
...
router.use("/location-featured-categories", locationFeaturedCategories)
router.use("/finance", finance)
router.use("/preferences", preferences)
router.use("/app", appContent)
